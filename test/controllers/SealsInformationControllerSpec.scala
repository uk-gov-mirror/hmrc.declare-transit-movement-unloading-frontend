...
class SealsInformationControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val sealsInformationRoute = routes.SealsInformationController.onPageLoad(mrn, NormalMode).url
  ...
  "SealsInformation Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(mrn).set(SealsInformationPage, "answer").success.value
