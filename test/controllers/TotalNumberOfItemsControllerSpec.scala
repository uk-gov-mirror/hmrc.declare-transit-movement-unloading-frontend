...
class TotalNumberOfItemsControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "TotalNumberOfItems Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(mrn, mrn).set(TotalNumberOfItemsPage, validAnswer).success.value
