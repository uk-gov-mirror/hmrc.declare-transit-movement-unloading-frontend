...
class GrossMassAmountControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val grossMassAmountRoute = routes.GrossMassAmountController.onPageLoad(mrn, NormalMode).url
