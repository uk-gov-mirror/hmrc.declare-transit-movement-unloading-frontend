...
class ConfirmRemoveCommentsControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "ConfirmRemoveComments Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(mrn).set(ConfirmRemoveCommentsPage, true).success.value
