...
class TotalNumberOfPackagesControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "TotalNumberOfPackages Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(mrn).set(TotalNumberOfPackagesPage, validAnswer).success.value
